    ...
    <div className="overflow-x-hidden w-full">
      <div>
        ...
        <div className="flex justify-center flex-col gap-6 sm:gap-8 md:gap-12 items-center px-4">
          <h1 className="font-ObjectSans text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-center">FES</h1>
        ...
        <div className="max-w-[1350px] m-auto px-4 sm:px-8 md:px-12 lg:px-20 flex flex-col lg:flex-row mt-20 sm:mt-28 md:mt-36 mb-16 sm:mb-20 md:mb-24 gap-8 lg:gap-0">
          <div className="w-full lg:w-[70%] font-NeueMachina">
            <div className="font-NeueMachina flex flex-col">
              ...
              <span className="text-sm sm:text-base">2026</span>
            </div>
            <div className="mt-8 sm:mt-12 md:mt-16">
              ...
              <p className="text-sm sm:text-base leading-relaxed mt-2">
                FES is a modern front-end project built to showcase
                advanced UI/UX design principles through smooth layouts, dynamic
                animations, and responsive interactions. Developed using Next.js,
                TypeScript, and GSAP, it serves as both a visual benchmark and an
                inspiration for building modern, aesthetic web interfaces. As the
                front-end developer, I focused on creating fluid motion and spatial
                hierarchy using complex GSAP animations, interactive scroll
                sequences, and dynamic user interfaces. The project emphasizes
                strict typing with TypeScript for robust code architecture,
                component reusability, and adaptability across screen sizes. Key
                highlights include seamless scroll and mouse-triggered animations
                driven by GSAP, performant rendering with Next.js, and beautifully
                structured sections — all optimized for performance and consistency.
              </p>
            </div>
          </div>
          <div className="flex flex-col lg:ml-43 gap-8 sm:gap-10 md:gap-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="https://fes-webapp-v2.vercel.app/">
            ...
            <div className="flex transparent mb-16 sm:mb-18 md:mb-20 h-auto sm:h-[16rem] md:h-[15rem] group border rounded-2xl justify-between items-center p-4 sm:p-5 flex-col sm:flex-row gap-4 sm:gap-0">
              <div className="w-full sm:w-auto">
                <div className="flex group gap-2 justify-center sm:justify-start">
                  <p className="code-content font-NeueMachina text-sm sm:text-base">
                    01
                  </p>
              ...
              <div className="flex group items-center gap-4 w-full sm:w-auto justify-center">
                ...
                <div className="flex flex-col items-center justify-center">
                  <div className="font-NeueMachina font-thin text-sm sm:text-base">
                    2025
                  </div>
                  <div className="font-NeueMachina font-thin text-xl sm:text-2xl">
                    ↗
                  </div>
                </div>
              </div>
